...
private:
    ...
    void fedestroykey();
    void feupdatekey();
    void fedrawbackground(bool motionblur);
    void fecreateladders();
    void fedestroyladders();
    void fecreatefloors();
    void fedestroyfloors();
    void feupdateplayer();
    void fecreateplayer();
    void fedestroyplayer();
    void feupdateenemies();
    void fecreateenemies(bool levelsucces);
    void fecreateenemy(int row, float x, int state, int group, int multiply);
    void feenemyenablelevelend();
    void fedestroyenemies();
    void feupdatecollectables();
    void fecreatecollectables(int ignorerow);
    void fedestroycollectable(int index);
    void fedestroyallcollectables();
public:
